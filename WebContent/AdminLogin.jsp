...
<body>
    <div class="contact-clean" style="padding: 132px;">
        <form  id="form_id" method="post" name="login" action="DoctorAPI">
            ...
            <div class="form-group"><button id ="submit" class="btn btn-primary" type="submit" onclick="return check(this.form)" value="Login" style="margin: 32px;margin-right: 54px;margin-top: 22px;margin-bottom: -30px;margin-left: 32px;">
            Login&nbsp;</button></div>
            <br>
            <h4>username : "admin" <br> password : "admin"</h4>
        </form>
    </div>
